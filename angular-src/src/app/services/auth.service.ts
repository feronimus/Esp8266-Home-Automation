...
export class AuthService {
  ...
  getFirmwareGroups(data){
    ...
    //return this.http.post('firmware/groups',data,{headers: headers}).pipe(map((response: any) => response));
    return this.http.post('http://localhost:3000/firmware/groups',data,{headers: headers}).pipe(map((response: any) => response));
  }
